...
const updateWeatherOutput = async (json, site) => {
    ...
    const temp_element_1 = document.querySelector('#new_temp')
    temp_element.innerHTML = temp_output    
    temp_element_1.innerHTML = temp_output   
    ...
    // set coords at top of page
    const new_lat_long = document.querySelector('#new_lat_long');
    new_lat_long.textContent = `${site} - LAT: ${latitude} LON: ${longitude}`
    ...
    const dewpoint_element_new = document.querySelector('#new_dew')
    dewpoint_element_new.innerHTML = dewpoint_output
    ...
    const wind_element_1 = document.querySelector('#new_wind')
    wind_element_1.innerHTML = wind_output
    ...
    const pressure_element_1 = document.querySelector('#new_press')
    pressure_element_1.innerHTML = pressure_output
    ...
    const sky_condition_element_1 = document.querySelector('#new_sky')
    ...
    if(metar.sky_condition != undefined)
    {
        ...
        sky_condition_element_1.innerHTML = sky_condition_output
    }
    ...
    const flight_category_element_1 = document.querySelector('#new_category')
    flight_category_element.innerHTML = flight_category_output
    flight_category_element_1.innerHTML = flight_category_output
...
const selectWeatherIcon = async (json) => {
    ...
    await getSunriseSunset(lat, lng)
        ...
        .then(json => {
            ...
            const weather_icon_element_1 = document.querySelector('#new_icon')
            weather_icon_element.innerHTML = weather_icon_output
            weather_icon_element_1.innerHTML = weather_icon_output
